                        ...
                        <CardContent className="p-0">
                            <div className="flex items-center p-5 gap-5">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-sm font-bold text-slate-900 dark:text-white tracking-wide">{item.title}</h3>
                                    <p className="text-[11px] font-bold text-slate-500 tracking-wide mt-0.5">{item.description}</p>
                                </div>
